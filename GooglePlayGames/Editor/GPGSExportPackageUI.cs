...
namespace GooglePlayGames
{
    ...
    public class GPGSExportPackageUI
    {
        ...
        public static void MenuItemGPGSExportUIPackage()
        {
			...
			AddToList(exportList, "Assets/SGLib/GooglePlayGames");
			AddToList(exportList, "Assets/SGLib/Plugins/Android/libs");
			AddToList(exportList, "Assets/SGLib/Plugins/Android/MainLibProj");
			AddToList(exportList, "Assets/SGLib/Plugins/iOS");

			exportList.Remove("Assets/SGLib/GooglePlayGames/Editor/projsettings.txt");
			exportList.Remove("Assets/SGLib/GooglePlayGames/Editor/GPGSExportPackageUI.cs");
			exportList.Remove("Assets/SGLib/Plugins/Android/MainLibProj/AndroidManifest.xml");
