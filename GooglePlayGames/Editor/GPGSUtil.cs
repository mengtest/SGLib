...
namespace GooglePlayGames
{
    ...
    public static class GPGSUtil
    {
        ...
        private const string GameInfoPath = "Assets/SGLib/GooglePlayGames/GameInfo.cs";
        ...
        {
            return ReadFile(SlashesToPlatformSeparator("Assets/SGLib/GooglePlayGames/Editor/" + name + ".txt"));
        }
        ...
        public static void CopySupportLibs()
        {
            ...
            string supportJarDest =
                GPGSUtil.SlashesToPlatformSeparator("Assets/SGLib/Plugins/Android/libs/android-support-v4.jar");
            ...
            string libProjDestDir = GPGSUtil.SlashesToPlatformSeparator(
				"Assets/SGLib/Plugins/Android/google-play-services_lib");
        ...
        public static void GenerateAndroidManifest(bool needTokenPermissions)
        {
            string destFilename = GPGSUtil.SlashesToPlatformSeparator(
				"Assets/SGLib/Plugins/Android/MainLibProj/AndroidManifest.xml");
