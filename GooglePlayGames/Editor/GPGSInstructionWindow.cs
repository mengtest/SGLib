...
namespace GooglePlayGames
{
    ...
    public class GPGSInstructionWindow : EditorWindow
    {
        ...
        public void OnGUI()
        {
                ...
                if (!UsingCocoaPod)
                {
				instructions = GPGSUtil.ReadFile("Assets/SGLib/GooglePlayGames/Editor/ios_instructions");
                }
                else
                {
				instructions = GPGSUtil.ReadFile("Assets/SGLib/GooglePlayGames/Editor/cocoapod_instructions");
                }
